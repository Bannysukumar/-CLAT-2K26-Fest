...
export function EventCoordinators() {
    ...
    const coordinators = [
        {
            name: 'B. Shiva Shankar',
            image: '/New folder (2)/coadinator.jpeg',
            role: 'Lead Event Coordinator'
        },
        {
            name: 'B. Sruthi',
            image: '/New folder (2)/IMG_3743.jpg',
    ...
    return (
        <SectionWrapper id="coordinators" title="Event Coordinators">
            <motion.div
                ...
                whileInView="visible"
                viewport={{ once: true }}
                className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-8 px-4"
            >
